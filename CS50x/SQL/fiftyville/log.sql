...
-- Name from the people who match the data below
SELECT name FROM people WHERE 
-- People who spoke recived phone from the thief on the day and time of the theft
phone_number IN (
    SELECT receiver FROM phone_calls WHERE month = 7 AND day = 28 AND year = 2020 AND duration < 60 AND 
    caller = (
